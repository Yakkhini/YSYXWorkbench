...
static int parse_args(int argc, char *argv[]) {
  ...
  int o;
  while ( (o = getopt_long(argc, argv, "-bhf:l:i:d:p:", table, NULL)) != -1) {
    switch (o) {
      case 'b': sdb_set_batch_mode(); break;
      case 'f': enable_ftrace(optarg); break;
      ...
      default:
        ...
        printf("\t-i,--itrace=FILE        output instruction trace to FILE\n");

...
VL_ATTR_COLD void V__0301_alu___024root__trace_init_sub__TOP__0(V__0301_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_init_sub__TOP__0\n"); );
    // Init
...
VL_ATTR_COLD void V__0301_alu___024root__trace_init_top(V__0301_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_init_top\n"); );
    // Body
    V__0301_alu___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void V__0301_alu___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void V__0301_alu___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void V__0301_alu___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void V__0301_alu___024root__trace_register(V__0301_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&V__0301_alu___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&V__0301_alu___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&V__0301_alu___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void V__0301_alu___024root__trace_full_sub_0(V__0301_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void V__0301_alu___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_full_top_0\n"); );
    // Init
    V__0301_alu___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<V__0301_alu___024root*>(voidSelf);
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    V__0301_alu___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void V__0301_alu___024root__trace_full_sub_0(V__0301_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_full_sub_0\n"); );
    // Init

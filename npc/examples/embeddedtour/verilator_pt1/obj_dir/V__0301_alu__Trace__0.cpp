...
void V__0301_alu___024root__trace_chg_sub_0(V__0301_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void V__0301_alu___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    V__0301_alu___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void V__0301_alu___024root__trace_chg_sub_0(V__0301_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_chg_sub_0\n"); );
    // Init
...
void V__0301_alu___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    V__0301_alu___024root__trace_cleanup\n"); );
    // Init
    V__0301_alu___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<V__0301_alu___024root*>(voidSelf);
    V__0301_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
